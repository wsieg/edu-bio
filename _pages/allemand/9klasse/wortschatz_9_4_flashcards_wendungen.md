---
layout: single
title: Wortschatz (Wendungen und Sätze) Kapitel 4
permalink: /allemand_main/9klasse_main/wortschatz4_lernkarten_wendungen
classes: wide
---
...
const flashcardData = {{ site.data.w9.wortschatz_9_4_wendungen | jsonify }};
const varFront = 'fr';
const varBack = 'de';
