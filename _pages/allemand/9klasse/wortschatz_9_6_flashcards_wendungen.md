---
layout: single
title: Wortschatz (Wendungen und Sätze) Kapitel 6
permalink: /allemand_main/9klasse_main/wortschatz6_lernkarten_wendungen
classes: wide
---
...
const flashcardData = {{ site.data.w9.wortschatz_9_6_wendungen | jsonify }};
const varFront = 'fr';
const varBack = 'de';
