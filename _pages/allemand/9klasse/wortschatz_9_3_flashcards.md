---
layout: single
title: Wortschatz (Wörter und Verben) Kapitel 3
permalink: /allemand_main/9klasse_main/wortschatz3_lernkarten
classes: wide
---
...
function updateFlashcard() {
  ...
  document.getElementById('front-side').innerText = member[varArtikelfr] + " " + member[varFront];
  setTimeout(() => {
