---
layout: single
title: Wortschatz (Wendungen und Sätze) Kapitel 7
permalink: /allemand_main/9klasse_main/wortschatz7_lernkarten_wendungen
classes: wide
---
...
const flashcardData = {{ site.data.w9.wortschatz_9_7_wendungen | jsonify }};
const varFront = 'fr';
const varBack = 'de';
